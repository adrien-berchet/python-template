...
```bash
copier git@bbpgitlab.epfl.ch:neuromath/python-template.git <new_project_directory>
```
...
remove the one that are not present in the new template. After that, review the changes and commit
