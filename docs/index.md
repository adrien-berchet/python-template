...
This directory contains long-form documentation for the template repository
itself. It complements the root `README.md` with deeper guidance on how to use,
extend, and maintain the template.
